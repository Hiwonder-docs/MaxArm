...
⑭ Set the running time to 500ms and click **"Add action"**.

<img src="../_static/media/chapter_3/section_3/01/media/image16.jpeg" class="common_img" />
⑮ Click **"Z+"** to lift MaxArm. Set the running time to 800ms and click **"Add action"**.

<img src="../_static/media/chapter_3/section_3/01/media/image17.jpeg" class="common_img" />
⑯ Click **"Reset"** ans set the initial posture as the ending action. Then set the running time to 1200ms and click **"Add action"**.
