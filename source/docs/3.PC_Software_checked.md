...
<img src="../_static/media/chapter_3/section_2/01/media/image8.jpeg" class="common_img" />
...
(6) Set the running time to 800ms and click **"Add action"** to add current action to action data list.
