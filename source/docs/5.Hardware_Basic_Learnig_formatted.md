...
<img src="../_static/media/chapter_5/section_1/02/media/image3.jpeg" class="common_img" />
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Game Programs/Control a Single PWM Servo/Single_PWMServo/Single_PWMServo.ino]()
...
The path to source code of program is [5. MaxArm Hardware Basics Learning/Arduino Development/Game Programs/Control PWM Servo Speed/PWMServo_speed/PWMServo_speed.ino]()
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Game Programs/Control Multiple PWM Servos/Multi_PWMServo\Multi_PWMServo.ino]()
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Game Programs/Control BUS Servo/ BusServo_turn/BusServo_turn.ino]()
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Game Programs/Control BUS Servo Speed/ BusServo_turn/BusServo_speed.ino]()
...
The path to the source code of the program is [5.MaxArm Hardware Basic Learning/Arduino Development/Game Programs/Read Bus Servo Status/BusServo_status/BusServo_status.ino]()
...
According to the following [circuit diagram](), 12 and 32 on the expansion board have serial ports function.
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Game Programs/ADC Detect Voltage/ Detecting_Voltage\Detecting_Voltage.ino]()
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Game Programs/Button Detection/ Key_Detect/Key_Detect.ino]().
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Game Programs/LED/LED_Blink/LED_Blink.ino]()
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Game Programs/Timer/Timer/Timer.ino]()
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Game Programs/Buzzer Control/ Buzzer_Control/Buzzer_Control.ino]()
...
The path to the source code of the program is [5.MaxArm Hardware Basic Learning/Arduino Development/Game Programs/Control Air Pump/ Nozzle_Control/Nozzle_Control.ino]()
...
The path to the source code of the program is [5. MaxArm Hardware Basic Learning/Arduino Development/Serial Communication/Uart/Uart.ino]()
...
<img src="../_static/media/chapter_5/section_2/02/media/image3.jpeg" class="common_img" />
...
The path to the source code of the program is [5. Hardware Basic Learning/ Python Development/Program Files/Control a Single PWM Servo /main.py]()
...
The path to the source code of the program is [5.Hardware Basic Learning/ Python Development/Program Files/Control PWM Servo Speed/main.py]()
...
The path to the source code of the program is [5.Hardware Basic Learning/Python Development/Program Files/Control Bus Servo/main.py]()
...
The path to the source code of the program is [5.Hardware Basic Learning/Python Development/Program Files/Control Bus Servo Speed/ main.py]()
...
The path to the source code of the program is [5.Hardware Basic Learning/Python Development/Program Files/Read Bus Servo Status/ main.py]()
...
The path to the source code of the program is [5.Hardware Basic Learning /Python Development/Program Files/ADC/ main.py]()
...
A control system usually consists of input, output, microcomputer, memory and etc, and the button, as one of the most commonly used input devices, can used to connect or control the circuit so as to achieve the purpose of [triggering control]().

* **Working Principle**

The path to the source code of the program is [5.Hardware Basic Learning/ Python Development/Program Files/KEY/main.py]()
...
The path to the source code of the program is [5. Hardware Basic Learning/ Python Development/Program Files/LED/main.py]()
...
The path to the source code of the program is [5.Hardware Basic Learning/ Python Development/Program Files/Control Buzzer/main.py]()
...
The path to the source code of the program is [5.Hardware Basic Learning/ Python Development/Program Files/Control Air Pump/main.py]()
